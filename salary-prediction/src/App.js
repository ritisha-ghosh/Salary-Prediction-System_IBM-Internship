...
import { predictSalary } from "./utils/predictions"
import "./App.css"
              ...
              <CardContent>
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-green-600">+₹80,000-1,20,000/year</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Location Factor:</span>
                    <span className="text-blue-600">Mumbai: +15%</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Education Bonus:</span>
                    <span className="text-purple-600">MBA: +₹2,50,000</span>
                  </div>
                  <div className="flex justify-between">
                    <span>MNC Premium:</span>
                    <span className="text-orange-600">+₹3,00,000</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Fresher Range:</span>
                    <span className="text-gray-600">₹2.5L - ₹6L</span>
                  </div>
                </div>
              </CardContent>
            </Card>
